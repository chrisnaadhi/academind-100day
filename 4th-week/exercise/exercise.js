...
const addBgColor = document.querySelector('#add');

// 2
// removeParagraph.addEventListener('click', () => {
//   let btnDetail = removeParagraph;
//   console.dir(btnDetail);
// })

// addBgColor.addEventListener('click', () => {
//   console.dir(addBgColor);
// })

// 3
const firstParagraphElement = document.body.children[2].children[1];
console.log(firstParagraphElement);
const secondParagraphElement = document.body.children[2].children[3];
console.log(secondParagraphElement)

// 4 
const removedText = document.querySelector('#removeParagraph');
